...
BTG 的核心玩法是：通过摄像头、麦克风、心率带、小米手环蓝牙广播等设备**实时感知人体状态**，
再由 **LLM（大语言模型）根据预设剧本 / 工作流 / 实时生理数据**，动态控制
**DG-LAB 郊狼（Coyote）、役次元（Yokonex）、Buttplug 生态**等电刺激 / 振动设备，
形成「感知 → 决策 → 反馈」的赛博闭环。
